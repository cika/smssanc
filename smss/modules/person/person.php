...
echo "<Tr bgcolor=#FFCCCC align=center class=style2><Td width='50'>ที่</Td><Td width='150'>เลขประจำตัวประชาชน</Td><Td width='300'>ชื่อ</Td><Td>ตำแหน่ง</Td><Td>ลำดับ</Td><Td width='50'>รูปภาพ</Td><Td  width=40>ลบ</Td><Td  width=40>แก้ไข</Td></Tr>";
$N=1;
$M=1;
while ($result = mysql_fetch_array($dbquery))
	{
