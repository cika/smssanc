...
echo "<Tr bgcolor=#FFCCCC align='center' class='style1'><Td width='50'>ที่</Td><Td width='150'>วดป</Td><Td width='120'>ประเภท</Td><Td>ข้อความ</Td><Td width='50'>File</Td><Td width='120'>ผู้รายงาน</Td></Tr>";
...
While ($result = mysql_fetch_array($dbquery))
	{
		...
		echo "<Tr bgcolor='$color' align='center'><Td class='style1'>$N</Td><td>$report_date</td><Td align='left' class='style1'>$section_ar[$section]</Td><Td align='left' class='style1'>$news</Td>";
if($file!=""){
...
echo "<Td align='left' class='style1'>$person_ar[$officer]</Td>";
echo "</Tr>";
$M++;
