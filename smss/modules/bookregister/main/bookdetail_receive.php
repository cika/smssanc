...
$sql = mysql_query ("SELECT * FROM  bookregister_receive WHERE  ms_id='$_REQUEST[id]' ") ;
...
$sql_file = mysql_query ("SELECT * FROM bookregister_receive_filebook WHERE  ref_id = '$ref_id' order by id ") ;
$road="../upload_files1/";
}
else if($result['book_link']==1){
$sql_file = mysql_query ("SELECT * FROM  book_filebook WHERE ref_id='$ref_id' order by id") ;
$road="../../book/upload_files/";
}
else if($result['book_link']==2){
$sql_file = mysql_query ("SELECT * FROM  bookregister_send_filebook_sch WHERE ref_id='$ref_id' order by id") ;
