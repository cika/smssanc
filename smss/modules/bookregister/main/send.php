...
echo "<td colspan='3' align='left'>&nbsp;<input type='text' name='book_from' size='80'  style='background-color: #E7D8EB' value='$_SESSION[school_name]'> </td>";
echo "</tr>";
...
echo "<tr>";
echo "<td align='right'><span lang='th'><font size='2' color='#0000FF'>เลขทะเบียน&nbsp;</font></span></td align='left'>";
...
$sql = "update bookregister_send set book_no='$_POST[book_no]', signdate='$_POST[signdate]', book_from='$_POST[book_from]', book_to='$_POST[book_to]', subject='$_POST[subject]', workgroup='$_POST[group]', operation='$_POST[operation]', comment='$_POST[comment]', secret='$_POST[secret]',officer='$user'  where ms_id='$_POST[id]' ";
$dbquery = mysql_query($sql);
...
$url_link="option=bookregister&task=main/send&search_index=$_REQUEST[search_index]&field=$_REQUEST[field]&search=$_REQUEST[search]";  // 2_กำหนดลิงค์ฺ
...
// ตรวจสอบไฟล์แนบ
$file = mysql_query ("SELECT id FROM  bookregister_send_filebook WHERE ref_id='$ref_id' ") ;
...
echo "<tr><td colspan='14'>&nbsp;&nbsp;<FONT COLOR='#009933'><IMG SRC='modules/bookregister/images/file1.gif' WIDTH='16' HEIGHT='16' BORDER='0'>มีไฟล์เอกสาร</FONT></td></tr>";
echo "</table>";
}  //end index
