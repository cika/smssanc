...
echo "<Tr align='left'><Td align='right'>ระหว่างลาติดต่อได้ที่&nbsp;&nbsp;</Td><Td><Input Type='Text' Name='contact' Size='60'>&nbsp;&nbsp;เบอร์โทรศัำพท์&nbsp;&nbsp;<Input Type='Text' Name='contact_tel'  Size='10'></Td></Tr>";
...
echo "<tr align='center'><td>ป่วย</td><td><Input Type='Text' Name='sick_ago'  Size='5'></td><td><Input Type='Text' Name='sick_this' Size='5'></td><td><Input Type='Text' Name='sick_total' Size='5'></td></tr>";

echo "<tr align='center'><td>กิจส่วนตัว</td><td><Input Type='Text' Name='privacy_ago' Size='5'></td><td><Input Type='Text' Name='privacy_this' Size='5'></td><td><Input Type='Text' Name='privacy_total' Size='5'></td></tr>";

echo "<tr align='center'><td>คลอดบุตร</td><td><Input Type='Text' Name='birth_ago' Size='5'></td><td><Input Type='Text' Name='birth_this' Size='5'></td><td><Input Type='Text' Name='birth_total' Size='5'></td></tr>";
echo "</table>";
...
echo "<Td>มีวันลาพักผ่อนสะสม&nbsp;&nbsp;<Input Type='Text' Name='relax_collect' Size='5'>&nbsp;&nbsp;วันทำการ และประจำปีอีก 10 วันทำการ รวมเป็น&nbsp;&nbsp;<Input Type='Text' Name='relax_this_year' Size='5'>&nbsp;&nbsp;วันทำการ";
...
echo "<tr align='center'><td><Input Type='Text' Name='relax_ago'  Size='5'></td><td><Input Type='Text' Name='relax_this' Size='5'></td><td><Input Type='Text' Name='relax_total' Size='5'></td></tr>";
