...
echo "<Center>";
echo "<Font color='#006666' Size=3><B>เจ้าหน้าที่ตรวจสอบข้อมูล</B></Font>";
echo "</Cener>";
echo "<Br><Br>";
...
$date_time_now = date("Y-m-d H:i:s");
		$sql = "update la_main set officer_comment='$_POST[officer_comment]', 
...
echo "<Tr ><Td colspan='2' align='right'><INPUT TYPE='button' name='smb' value='<<กลับหน้าก่อน' onclick='location.href=\"?option=la&task=main/la_officer_comment&page=$_GET[page]\"'></Td></Tr>";
...
$url_link="option=la&task=main/la_officer_comment";  // 2_กำหนดลิงค์ฺ
...
$sql="select * from la_main order by id limit $start,$pagelen";
$dbquery = mysql_query($sql);

echo  "<table width='95%' border='0' align='center'>";

echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='60'>เลขที่</Td><Td width='130'>ผู้ขออนุญาต</Td><Td width='100'>วันขออนุญาต</Td><Td width='100'>ประเภทการลา</Td><Td>ตั้งแต่วันที่ี</Td><Td>ถึงวันที่</Td><Td width='80'>มีกำหนด</Td><Td width='50'>เอกสาร</Td><Td width='60'>รายละเอียด</Td><Td colspan='2'>ตรวจสอบ</Td></Tr>";
...
echo "<Tr bgcolor='$color'><Td valign='top' align='center'>$id</Td><Td valign='top' align='center'>$full_name_ar[$person]</Td><Td valign='top' align='left'>";
...
echo "<Td valign='top' align='center'><a href=?option=la&task=main/la_officer_comment&index=7&id=$id&page=$page><img src=images/browse.png border='0' alt='รายละเอียด'></Td>";
...
echo "<Td align='center'><a href=?option=la&task=main/la_officer_comment&index=5&id=$id&page=$page><img src=images/edit.png border='0' alt='เจ้าหน้าที่ตรวจสอบ'></a></Td>";
}
else{
echo "<td></td>";
}
...
function goto_url_update(val){
	if(val==0){
		callfrm("?option=la&task=main/la_officer_comment");   // page ย้อนกลับ 
	}else if(val==1){
			callfrm("?option=la&task=main/la_officer_comment&index=6");  
	}
}
