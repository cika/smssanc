...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>รายการยกเลิกวันลาทั้งหมด</strong></font></td></tr>";
echo "</table>";
echo "<br>";
...
$url_link="option=la&task=main/report_3";  // 2_กำหนดลิงค์ฺ
