...
<tr>
<td height="30" bgcolor="#0066FF"><?php echo $t2;?><font color="#FFFFFF">รายงาน :: ตรววจสุขภาพนักเรียนรายบุคคล</font></td>
</tr>
  <tr>
    <td>
    <table width="1198" border="0">
      <tr>
        ...
        <form name="form1" action="?option=health&&task=report_all_type_personal_std2" method="post" enctype="multipart/form-data">
      <tr>
      ...
      <tr>
        <td align="left">ปีการศึกษา :
          <?php echo $year_bs;?></td>
        <td width="345" align="left">ระดับชั้น :
          <?php echo $recordCKC['class_name'];?><?php   if($recordCK['room']!=0){ ?>/<?php echo $recordCK['room'];?><?php  } ?></td>
        <td align="left">&nbsp;</td>
        <td align="center">&nbsp;</td>
      </tr>
      <tr>
  ...
  <?php echo $recordCK['surname'];?></td>
        <td width="394" align="left">เลขที่ :
    ...
    <td  valign="top"  height="260"><table width="1200" border="1" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="9%" align="center" valign="middle" bgcolor="#76CEEB">เทียบเกณฑ์<br>
          มาตรฐาน</td>
        <td width="5%" align="center" valign="middle" bgcolor="#76CEEB">เหงือก</td>
        ...
        <td width="6%" align="center" valign="middle" bgcolor="#76CEEB">นั่งงอตัว<br>
          ไปข้างหน้า<br>
          (ซม.)</td>
        <td width="5%" align="center" valign="middle" bgcolor="#76CEEB">วิ่ง 1200<br>
          เมตร<br>
          (นาที)</td>
        <td width="7%" align="center" valign="middle" bgcolor="#76CEEB">วันเวลา<br>
          ที่ตรวจ</td>
        <td width="12%" align="center" valign="middle" bgcolor="#76CEEB">หมายเหตุ</td>
      </tr>
      <?php 
...
<!-- end check 1 term 1 -->
   ...
   <!--- start check 2 term 1-->
        <?php
				...
				$sum_sex1_k2=0; $sum_sex2_k2=0; $sum_sex_low1_k2=0; $sum_sex_over1_k2=0; $valsum2 = 0 ; /* คืนค่าเป็น 0*/
				/* คำนวณหาน้ำหนักตามเกณฑ์มาตรฐาน*/
				if($recordsex2['sex']==1){
...
<!-- end check 2 term 1 -->
  <!--- start check 1 term 2-->
        <?php
				...
				$sum_sex1_k3=0; $sum_sex2_k3=0; $sum_sex_low1_k3=0; $sum_sex_over1_k3=0; $valsum3 = 0 ; /* คืนค่าเป็น 0*/
				/* คำนวณหาน้ำหนักตามเกณฑ์มาตรฐาน*/
				if($recordsex3['sex']==1){
...
<!-- end check 1 term 2 -->
      <!--- start check 2 term 2-->
        <?php
				...
				$sum_sex1_k4=0; $sum_sex2_k4=0; $sum_sex_low1_k4=0; $sum_sex_over1_k4=0; $valsum4 = 0 ; /* คืนค่าเป็น 0*/
				/* คำนวณหาน้ำหนักตามเกณฑ์มาตรฐาน*/
				if($recordsex4['sex']==1){
