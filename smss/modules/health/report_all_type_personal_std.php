...
<td height="30" bgcolor="#0066FF"><?php echo $t2;?><font color="#FFFFFF">รายงาน :: ตรววจสุขภาพนักเรียนรายบุคคล</font></td>
  ...
  <tr>
    ...
    <table width="1198" border="0">
      <tr>
        ...
        <form name="form1" action="?option=health&&task=report_all_type_personal_std" method="post" enctype="multipart/form-data">
      <tr>
      ...
      <tr>
        <td align="left">ปีการศึกษา :
          <?php echo $year_bs;?></td>
        <td width="327" align="left">ระดับชั้น :
  ...
  <?php echo $recordCK['surname'];?></td>
        <td width="410" align="left">เลขที่ :
