...
echo  "<option value = '3'>ประถมศึกษาปีที่ 3</option>";
echo  "<option value = '8'>มัธยมศึกษาปีที่ 2</option>";
echo "</select>";
echo "</div></td></tr>";
		...
		$test_level=$_POST[$M][11];			
						...
						$data_num=mysql_num_rows($dbquery_select);
									...
									$dbquery_update = mysql_query($sql_update);
													...
													if($score_avg>0){
													$sql_insert = "insert into achievement_main (test_type, test_class, ed_year, level, thai, math, science, social, english, health, art,vocation, score_avg, officer, rec_date) values ('2', '$_REQUEST[test_class]', '$ed_year', '$test_level', '$thai', '$math', '$science', '$social', '$english', '$health', '$art', '$vocation', '$score_avg', '$officer', '$rec_date')";
