...
$rec_date=date("Y-m-d");
		...
		$test_level=$_POST[$M][11];			
						...
						$sql_select = "select * from  achievement_main  where  level='$M' and ed_year='$ed_year' and test_class='$test_class' and test_type='1' ";
						...
						$data_num=mysql_num_rows($dbquery_select);
									...
									officer='$officer',
									rec_date='$rec_date' 
									where  test_type='1' and test_class='$test_class' and ed_year='$ed_year' and level='$test_level' ";
									$dbquery_update = mysql_query($sql_update);
									}
									else {
													if($score_avg>0){
													$sql_insert = "insert into achievement_main (test_type, test_class, ed_year, level, thai, math, science, social, english, health, art,vocation, score_avg, officer, rec_date) values ('1', '$test_class', '$ed_year', '$test_level', '$thai', '$math', '$science', '$social', '$english', '$health', '$art', '$vocation', '$score_avg', '$officer', '$rec_date')";
...
echo "<tr align='center'>
	<td align=center><font color='#990000' size='3'><strong>บันทึกคะแนน O-NET $class_ar[$test_class]  ปีการศึกษา $ed_year </strong></font>
