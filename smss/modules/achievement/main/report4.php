...
$year_num=$year_num-1;  //จำนวนปีที่แสดง
  ...
  for($x=$year_num;$x>0;$x--){
	$strQuery = "select thai, math, science, social, english, health, art, vocation, score_avg from achievement_main where test_type='2' and test_class='3' and ed_year='$ed_year_ar[$x]' and level='1' ";
			$result = mysql_query($strQuery);
