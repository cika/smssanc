...
<td align='left' > <textarea name='eval_activity' rows = '6' cols='60'><?php echo $w_eval_activity?></textarea>
</td></tr>
<tr><td align="right"><b><font size="3" face="MS Sans Serif" color="#009900">ผลการดำเนินงาน&nbsp;&nbsp;</font></b></td>
<td align='left' > <textarea name='eval_result' rows = '6' cols='60'><?php echo $w_eval_result?></textarea>
</td></tr>
 <tr><td align="right"><b><font size="3" face="MS Sans Serif" color="#009900">ข้อค้นพบหรือข้อเสนอแนะ&nbsp;&nbsp;</font></b></td>
<td align='left' > <textarea name='eval_obstacle' rows = '6' cols='60'><?php echo $w_eval_obstacle?></textarea>
</td></tr>
 <tr><td align="right"><b><font size="3" face="MS Sans Serif" color="#009900">Upload ไฟล์&nbsp;&nbsp;</font></b></td>
<td align='left' ><input type = 'file'  name = 'userfile'  id= 'file'>
</td></tr>
 ...
 <?php
echo "<p align='center'>";
echo "<INPUT TYPE='button' name='smb' value='ตกลง' onclick='goto_url(1)' class='button'><INPUT TYPE='button' name='smb' value='ย้อนกลับ' onclick='goto_url(0)' class='button'>";
echo "</p>";
?>
<!-- Part2 -->
<BR>
...
function goto_url(val){
	if(val==0){
		...
		callfrm("?option=plan&task=planproject/plan_report_upload&plan_proj_id=<?php echo $id?>&year_index=<?php echo $budget_year?>&workgroup=<?php echo $workgroup?>");   //page ประมวลผล
	}
}
</script>
