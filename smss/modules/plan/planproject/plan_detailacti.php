...
<Br><Font Size=3 color='#000099'><B>รายละเอียดกิจกรรมของโครงการ ปีงบประมาณ <?php echo $_SESSION['budget_year']?></B></Font></p>
...
<TABLE width="100%" border="0" borderColor=#FF0033 cellpadding="0" cellspacing="0" >
    <tr> 
      <TD>
			...
			<tr><td align="right"><b><font color="#003333" size="2" face="MS Sans Serif">วัน- เดือน-ปี บันทึกข้อมูล : </font></b></td>
                    <td align="left"> <input size=10 type=text name="vcode_acti" maxlength=10 value='<?php echo $daythai?>'></tr>
					 <tr> 
                    <td align="right" width="40%"><b><font color="#003333" size="2" face="MS Sans Serif">รหัสกิจกรรม :</font></b></td>
                    <td align="left"> <input size=6 type=text name="vcode_acti" maxlength=6 value=<?php echo $code_acti?>> 
                    </td></tr>
				<tr> 
...
<tr> 
				...
				<tr> 
					...
					<?php  $tbudget_acti=number_format($tbudget_acti,2)   ?>
...
echo "<br />";
echo "<div align='center'>ยังไม่ได้กำหนดทำงานในปีงบประมาณใด ๆ</div>";
}
...
function goto_url_update(val){
	...
	{ 
				if(acti_form.vcode_acti.value == "")
						{
						alert("กรุณาป้อน	รหัสกิจกรรม \n 001,002,...");
						document.acti_form.vcode_acti.focus();
						return false;
						}
				else if(acti_form.vname_acti.value == "")
						{
						alert("กรุณาป้อน กิจกรรม");
						document.acti_form.vname_acti.focus();
						return false;
						}
				else if(acti_form.vbudget_acti.value == "")
						{
						 alert("กรุณาป้อน จำนวนเงิน");
						document.acti_form.vbudget_acti.focus();
						return false;
						}
				else
